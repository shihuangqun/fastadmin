<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/Users/shihuangqun/yuyin/public/../application/admin/view/conf_level/edit.html";i:1564370387;s:67:"/Users/shihuangqun/yuyin/application/admin/view/layout/default.html";i:1564370387;s:64:"/Users/shihuangqun/yuyin/application/admin/view/common/meta.html";i:1564370387;s:66:"/Users/shihuangqun/yuyin/application/admin/view/common/script.html";i:1564370387;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Value'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-value" data-rule="required" class="form-control" name="row[value]" type="number" value="<?php echo htmlentities($row['value']); ?>">
        </div>
    </div>
    <div class="form-group">
